var diveCreateConfig = document.getElementById("diveCreateConfig");
var diveCreateIndexUrl = diveCreateConfig ? diveCreateConfig.dataset.indexUrl : "/";
var diveCreateTanksUrl = diveCreateConfig ? diveCreateConfig.dataset.getTanksUrl : "";
var diveCreateDefaultsUrl = diveCreateConfig ? diveCreateConfig.dataset.getDefaultsUrl : "";

window.redirectToIndex = function () {
    window.location.href = diveCreateIndexUrl;
};
...
window.onDivePlanChange = function () {
    ...
    if (diveCreateDefaultsUrl) {
        $.getJSON(diveCreateDefaultsUrl, { divePlanId: divePlanId })
            .done(function (d) {
